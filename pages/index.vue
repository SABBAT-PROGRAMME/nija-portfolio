...
<template>
  <section>
    <h1 class="text-5xl font-bold mt-20">
      <a
        href="https://www.flaticon.com/fr/icones-gratuites/bonjour"
        title="bonjour icônes"
      ></a>

      👋 Hello I'm Sabbat Lumpatshia
    </h1>
    <p class="text-base text-gray-900 p-2 italic">
      Spring Developer Advocate at Payrouter.
    </p>
  </section>
  ...
  <section class="flex flex-col md:flex-row">
    <div class="md:w-3/4">
      ...
      <p class="text-lg py-2">
        ...
        father of two little girls. I enjoy reading, running, and lifting
        weights to get me through the week.
      </p>
    </div>

    <img
      src="/assets/images/profil.avif"
      alt=""
      class="w-1/2 md:max-w-sm p-8 max-auto"
    />
  </section>

  <!-- section-3 -->

  <section><h2 class="text-3xl font-bold mt-8">Latest Blog Posts</h2></section>
</template>
